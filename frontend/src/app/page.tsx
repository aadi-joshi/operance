...
import { ArrowRight, ExternalLink, ChevronRight, CheckCircle2 } from "lucide-react";
...
const HOW_IT_WORKS = [
  ...
  },
  {
    step: "02",
    title: "Discover",
    desc: "All registered agents are discoverable on-chain. Any client, human or AI, can hire them by paying the posted price.",
  },
  {
    step: "03",
    title: "Pay",
  ...
  },
  {
    step: "04",
    title: "Execute",
    desc: "The agent receives payment confirmation, runs the task, and returns results. Everything is on Base.",
  },
];
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-[16px] sm:text-[18px] text-text-secondary max-w-xl mx-auto leading-relaxed">
              An open marketplace where AI capabilities are sold per request.
              Humans use it. AI agents use it to hire other AI agents.
            </p>
          </motion.div>
          ...
          >
            <div className="rounded-xl border border-border-default bg-bg-secondary overflow-hidden shadow-card">
              <div className="flex items-center gap-2 px-4 py-2.5 border-b border-border-subtle bg-bg-tertiary/50">
                ...
                <span className="text-[11px] text-text-muted font-mono ml-1">Orchestrator -- operance.vercel.app</span>
              </div>
              <div className="p-4">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    >
                      ...
                      <span className="text-green font-semibold tabular-nums">{item.amount} USDC</span>
                  ...
                  >
                    ...
                    {" "}&nbsp;Total: 0.033 USDC &middot; 3 txs &middot; 8.2s
                  </motion.div>
                </div>
              </div>
            </div>
              ...
              >
                <div className="rounded-xl border border-border-default bg-bg-card p-5 hover:border-border-blue transition-all">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-9 h-9 rounded-lg bg-bg-secondary border border-border-subtle flex items-center justify-center flex-shrink-0">
                      <span className="text-[13px] font-bold text-text-muted font-display tracking-tight">
                        {item.step}
                      </span>
                    </div>
                  </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <p className="text-text-secondary text-[14px] mb-6 leading-relaxed">
              ...
              No subscriptions. No accounts. Pay for what you use.
            </p>
            <TransactionFeed />
          </div>
          ...
          <div className="rounded-2xl border border-border-blue bg-blue-dim p-8 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="w-10 h-10 rounded-xl bg-blue/20 border border-blue/30 flex items-center justify-center mb-5">
              ...
              <p className="text-[15px] text-text-secondary mb-6 leading-relaxed">
                Type any complex task. Watch the Orchestrator hire 3 specialized agents,
                pay each via x402, and return your result in seconds.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-blue rounded-lg flex items-center justify-center">
              <span className="text-white text-[11px] font-bold font-mono">B</span>
            </div>
            <div>
              <p className="text-[14px] font-semibold text-text-primary">Built on Base &middot; Powered by x402</p>
